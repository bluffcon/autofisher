...
summon item ~ ~ ~ {Motion:[0,-0.4,0],Tags:["autofisher.fish"],Item:{id:ladder}}
...
execute unless score @s autofisher.net.bait matches 3.. run scoreboard players set @s autofisher.net.cooldown 200
execute if score @s autofisher.net.bait matches 3.. run scoreboard players set @s autofisher.net.cooldown 50
