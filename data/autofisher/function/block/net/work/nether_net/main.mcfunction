...
execute if predicate {type:"random_chance",chance:0.15} run scoreboard players remove @s autofisher.net.cooldown 1
...
execute unless score @s autofisher.net.bait matches 3.. if predicate {type:"random_chance",chance:0.0001} run function autofisher:block/net/work/spawn_fish
execute if score @s autofisher.net.bait matches 3.. if predicate {type:"random_chance",chance:0.0005} run function autofisher:block/net/work/spawn_fish