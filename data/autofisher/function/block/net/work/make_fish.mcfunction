execute unless score @s autofisher.net.bait matches 3.. if predicate {condition:"random_chance", chance:0.08} run return run function autofisher:block/net/work/junk
