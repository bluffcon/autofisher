...
execute if predicate {type:random_chance,chance:0.2} run loot replace entity @n[type=item,distance=..2] container.0 loot autofisher:crafts/net_skin_packs/space
